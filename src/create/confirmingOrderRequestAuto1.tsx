...
export default function ConfirmingOrderRequestAuto1() {
  return (
...
export function ConfirmingOrderRequestAuto2() {
...
export function ConfirmingOrderRequestAuto3() {
  return (
    <div className="p-[30px] absolute w-full flex flex-col gap-[30px] items-start">
      <div className="px-[30px] py-5 border rounded-[20px] border-dashed flex items-start gap-[10px] self-stretch border-[#6750A4] w-full">
        <p className="text-[#6750A4] text-[28px] leading-9">
...
export function ConfirmingOrderRequestAuto4() {
...
export function confirmingOrderRequestAuto5() {
