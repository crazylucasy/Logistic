...
const  ConfirmingOrderRequestExport1 = () => {
  return (
...
const ConfirmingOrderRequestExport2 = () => {
  return (
    <div className="p-[30px] absolute w-full flex flex-col gap-[30px] items-start">
      <div className="px-[30px] py-5 border rounded-[20px] border-dashed flex items-start gap-[10px] self-stretch border-[#6750A4] w-full">
        <p className="text-[#6750A4] text-[28px] leading-9">
...
const ConfirmingOrderRequestExport3 = () => {
  return (
    <div className="p-[30px] absolute w-full flex flex-col gap-[30px] items-start">
      <div className="px-[30px] py-5 border rounded-[20px] border-dashed flex items-start gap-[10px] self-stretch border-[#6750A4] w-full">
        <p className="text-[#6750A4] text-[28px] leading-9">
...
const ConfirmingOrderRequestExport4 = () => {
...
const ConfirmingOrderRequestExport5 = () => {
...
const renderChildComponent = () => {
  switch (currentChildId) {
    case 1:
      return <ConfirmingOrderRequestExport1 />;
    case 2:
      return <ConfirmingOrderRequestExport2 />;
    case 3:
      return <ConfirmingOrderRequestExport3 />;
    case 4:
      return <ConfirmingOrderRequestExport4 />;
    case 5:
      return <ConfirmingOrderRequestExport5 />;
    default:
      return null;
  }
};
