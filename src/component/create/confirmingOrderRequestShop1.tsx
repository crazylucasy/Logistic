...
function ConfirmingOrderRequestShop1() {
  return (
...
function ConfirmingOrderRequestShop2() {
  return (
...
function ConfirmingOrderRequestShop3() {
  return (
    <div className="p-[30px] absolute w-full flex flex-col gap-[30px] items-start">
      <div className="px-[30px] py-5 border rounded-[20px] border-dashed flex items-start gap-[10px] self-stretch border-[#6750A4] w-full">
        <p className="text-[#6750A4] text-[28px] leading-9">
...
function ConfirmingOrderRequestShop4() {
...
function ConfirmingOrderRequestShop5() {
...
const renderChildComponent = () => {
  switch (currentChildId) {
    case 1:
      return <ConfirmingOrderRequestShop1 />;
    case 2:
      return <ConfirmingOrderRequestShop2 />;
    case 3:
      return <ConfirmingOrderRequestShop3 />;
    case 4:
      return <ConfirmingOrderRequestShop4 />;
    case 5:
      return <ConfirmingOrderRequestShop5 />;
    default:
      return null;
  }
};
