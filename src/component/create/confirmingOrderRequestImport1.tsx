...
//confirming import 1 start
const ConfirmingOrderRequestImport1 = () => {
  return (
    <div className="p-[30px] absolute w-full flex flex-col gap-[30px] items-start">
      <div className="px-[30px] py-5 border rounded-[20px] border-dashed flex items-start gap-[10px] self-stretch border-[#6750A4] w-full">
        <p className="text-[#6750A4] text-[28px] leading-9">
          Confirming Import Order Request
        </p>
      </div>
...
//confirming import 1 end

//confirming import 2 start
function Item2() {
  return (
    <div className="flex items-start gap-[10px] flex-col py-2.5 px-3.5 w-full text-[#49454F]">
      ...
      <div className="flex flex-col items-start gap-[30px] mt-[30px] px-5 pb-5 self-stretch w-full">
        ...
        <div className="flex flex-row gap-[30px] h-[56px] w-full">
          ...
          <Input type="number"
              className='basis-[30%] !border !rounded-[20px] border-[#79747E] !py-2 !pl-4" '
...
const ConfirmingOrderRequestImport2 = () => {
  return (
    <div className="p-[30px] absolute w-full flex flex-col gap-[30px] items-start">
      <div className="px-[30px] py-5 border rounded-[20px] border-dashed flex items-start gap-[10px] self-stretch border-[#6750A4] w-full">
        <p className="text-[#6750A4] text-[28px] leading-9">
...
//confirming import 2 end
//confirming import 3 start
...
const ConfirmingOrderRequestImport3 = () => {
  return (
    <div className="p-[30px] absolute w-full flex flex-col gap-[30px] items-start">
      <div className="px-[30px] py-5 border rounded-[20px] border-dashed flex items-start gap-[10px] self-stretch border-[#6750A4] w-full">
        <p className="text-[#6750A4] text-[28px] leading-9">
...
//confirming import 3 end
//confirming import 4 start
...
const ConfirmingOrderRequestImport4 = () => {
...
//confirming import 4 end
//confirming import 5 start
    ...
    <div className="flex flex-col items-start gap-[10px] self-stretch">
      ...
      <div className="grid grid-cols-5 items-start gap-5 px-3.5 pb-2.5 w-full">
        ...
        <div className="flex flex-col justify-between items-start gap-[5px] min-h-[73px]">
          ...
          <p className="text-[22px] leading-7 text-[#1C1B1F]">Import</p>
        </div>
        {/* Order Informatin Content row-2 column-1 end*/}
        {/* Order Informatin Content row-2 column-2 start*/}
        <div className="flex flex-col justify-between gap-[5px] min-h-[73px]">
...
const ConfirmingOrderRequestImport5 = () => {
...
//confirming import 5 end


const renderChildComponent = () => {
  switch (currentChildId) {
    case 1:
      return <ConfirmingOrderRequestImport1 />;
    case 2:
      return <ConfirmingOrderRequestImport2 />;
    case 3:
      return <ConfirmingOrderRequestImport3 />;
    case 4:
      return <ConfirmingOrderRequestImport4 />;
    case 5:
      return <ConfirmingOrderRequestImport5 />;
    default:
      return null;
  }
};
